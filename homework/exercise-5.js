...
JOSH and JAMIE are uppercase, while james and Mozafar are not. You want to return an array of mentors with the names in uppercase.
...
var mentorsNamedUppercased = mentorsNames.map((x) => x.toLocaleUpperCase());
